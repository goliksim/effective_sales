...
class FlightPreSearchBodyShimmer extends StatelessWidget {
  const FlightPreSearchBodyShimmer({
    super.key,
  });
              ...
              children: [
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, index) =>
                      ShimerBox(56, double.infinity, EdgeInsets.zero, color: context.myColors.grey2),
                  separatorBuilder: (context, index) => const SizedBox(
                    height: 8,
                  ),
                  itemCount: 2,
                ),
                ShimerBox(50, double.infinity, const EdgeInsets.only(top: 8), color: context.myColors.grey2),
                const SizedBox(
                  height: 6,
                ),
